...
export const SERVICE_TYPES = [
    { id: 'houmon_kaigo', name: '訪問介護' },
    { id: 'houmon_nyuyoku', name: '訪問入浴介護' },
    { id: 'houmon_kango', name: '訪問看護' },
    { id: 'houmon_rehab', name: '訪問リハビリテーション' },
    { id: 'tsusho_kaigo', name: '通所介護' },
    { id: 'tsusho_rehab', name: '通所リハビリテーション' },
    { id: 'tanki_seikatsu', name: '短期入所生活介護' },
    { id: 'tanki_ryoyo', name: '短期入所療養介護' },
    { id: 'tokutei_shisetsu', name: '特定施設入居者生活介護' },
    { id: 'fukushi_yogu', name: '福祉用具貸与' },
    { id: 'kaigo_rojin_fukushi', name: '介護老人福祉施設' },
    { id: 'kaigo_rojin_hoken', name: '介護老人保健施設' },
    { id: 'kaigo_iryoin', name: '介護医療院' },
    { id: 'ninchi_group', name: '認知症対応型共同生活介護' },
    { id: 'kyotaku_shien', name: '居宅介護支援' },
    { id: 'chiiki_houkatsu', name: '地域包括支援センター' },
];
